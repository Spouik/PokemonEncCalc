...
{
    internal class PokemonBW : Pokemon
    {
        internal const int RELEASED_POKEMON = 649;
        internal const int RELEASED_FORMS = 56;
        internal const int SIZE = 76;
        ...
        internal PokemonBW(short id, byte[] data)
        {
        ...
        internal void addForm(PokemonBW pokemon)
        {
            Forms.Add(pokemon);
        }
