...
{
    internal class PokemonORAS : Pokemon
    {


        internal const int RELEASED_POKEMON = 721;
        internal const int RELEASED_FORMS = 149;
        ...
        internal PokemonORAS(short id, byte[] data)
        {
        ...
        internal void addForm(PokemonORAS pokemon)
        {
            Forms.Add(pokemon);
        }
