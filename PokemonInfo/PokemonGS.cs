...
{
    class PokemonGS : Pokemon
    {
        internal const int RELEASED_POKEMON = 251;
        internal const int RELEASED_FORMS = 27;
        ...
        internal PokemonGS(short id, byte[] data)
        {
        ...
        internal void addForm(PokemonGS pokemon)
        {
            Forms.Add(pokemon);
        }
